...
urlpatterns = [
    ...
    url(r'^produtor/(?P<id_produtor>\d+)/cattle/transfer2producer$', views.transfer2producer, name='transfer2producer'),
    url(r'^produtor/(?P<id_produtor>\d+)/cattle/transfer2frigo$', views.transfer2frigo, name='transfer2frigo'),
